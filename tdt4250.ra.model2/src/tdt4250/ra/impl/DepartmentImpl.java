 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.ra.impl.DepartmentImpl#getCourses <em>Courses</em>}</li>
 *   <li>{@link tdt4250.ra.impl.DepartmentImpl#getStaff <em>Staff</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepartmentImpl extends MinimalEObjectImpl.Container implements Department {
	 ...
	 * @generated NOT
	 */
	public void allocateResource(Course course, Person resource, float factor) {
		// create ResourceAllocation object
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RaPackage.DEPARTMENT___ALLOCATE_RESOURCE__COURSE_PERSON_FLOAT:
				allocateResource((Course)arguments.get(0), (Person)arguments.get(1), (Float)arguments.get(2));
				return null;
		}
