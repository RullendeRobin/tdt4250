...
import tdt4250.ra.util.RaValidator;
...
public class RaPackageImpl extends EPackageImpl implements RaPackage {
	 ...
	 * @see tdt4250.ra.RaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getCourse_Roles() {
	 ...
	 * @generated
	 */
	public EReference getResourceAllocation_Role() {
	 ...
	 * @generated
	 */
	public EOperation getDepartment__AllocateResource__Course_Person_float() {
	...
	public void createPackageContents() {
		...
		createEReference(courseEClass, COURSE__ROLES);
		...
		createEReference(resourceAllocationEClass, RESOURCE_ALLOCATION__ROLE);
		...
		createEOperation(departmentEClass, DEPARTMENT___ALLOCATE_RESOURCE__COURSE_PERSON_FLOAT);
	...
	public void initializePackageContents() {
		...
		initEReference(getCourse_Roles(), this.getRole(), null, "roles", null, 0, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getResourceAllocation_Role(), this.getRole(), null, "role", null, 0, 1, ResourceAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = initEOperation(getDepartment__AllocateResource__Course_Person_float(), null, "allocateResource", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (courseEClass,
		   source,
		   new String[] {
			   "constraints", "needsEnoughResources rolesMustBeFilled"
		   });
		addAnnotation
		  (resourceAllocationEClass,
		   source,
		   new String[] {
			   "constraints", "resourceAllocationMustBeForSameCourse"
		   });
	}
	...
	protected void create_1Annotations() {
		...
		addAnnotation
		  (courseEClass,
		   source,
		   new String[] {
			   "rolesMustBeFilled", "true"
		   });
		addAnnotation
		  (resourceAllocationEClass,
		   source,
		   new String[] {
			   "resourceAllocationMustBeForSameCourse", "self.role.eContainer() = self.course"
		   });
	}
