...
public class SpFactoryImpl extends EFactoryImpl implements SpFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SpPackage.SPECIALIZATION: return createSpecialization();
			case SpPackage.UNIVERSITY: return createUniversity();
			case SpPackage.COURSE_GROUP: return createCourseGroup();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case SpPackage.ACADEMIC_LEVEL:
				return createAcademicLevelFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case SpPackage.ACADEMIC_LEVEL:
				return convertAcademicLevelToString(eDataType, instanceValue);
			case SpPackage.COURSE_TYPE:
	 ...
	 * @generated
	 */
	public AcademicLevel createAcademicLevelFromString(EDataType eDataType, String initialValue) {
		AcademicLevel result = AcademicLevel.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertAcademicLevelToString(EDataType eDataType, Object instanceValue) {
	...
	public String createCourseCodeFromString(EDataType eDataType, String initialValue) {
		if (!initialValue.matches("[a-zæøåA-ZÆØÅ]+[0-9]+")) {
			
			throw new IllegalArgumentException("Must be the correct format");
